...
This module deliberately lives outside :mod:`tinychess.nn` so engine and AI hot paths can
...
_ACTIVE_PROFILER: contextvars.ContextVar[SelfPlayProfiler | NoOpSelfPlayProfiler] = (
    contextvars.ContextVar("tinychess_self_play_profiler", default=_NOOP)
)
...
def profile_level_from_env(env_var: str = "TINYCHESS_SELF_PLAY_PROFILE") -> ProfileLevel:
