...
The profiling implementation lives in :mod:`vibechess.profiling` so engine and AI
hot paths can use instrumentation without importing :mod:`vibechess.nn` internals.
This module keeps the historical ``vibechess.nn.self_play_profile`` import path
working.
"""
